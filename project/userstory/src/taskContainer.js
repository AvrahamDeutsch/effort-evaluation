            ...
            <div style={{ width: '100%', border: 'solid gray 1px', margin: '5px', marginLeft: '0px' }}>
                ...
                <Row style={{ width: '90%', margin: '5px', marginLeft: '0px' }}>
                    <Col>
                        ...
                        {this.state.taskMode ? <Lines taskContainerUserStory={this.state.taskContainerUserStory} numberOfTasks={this.state.numberOfTasks}
                            ...
                            userStories={this.props.userStories} taskNameChange={this.taskNameChange} /> : null}
