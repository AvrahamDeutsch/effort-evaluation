...
//         axios.get(`http://10.2.1.107:3000/app/find_category/?category=${value}`)
//             .then(response => {
...
//                     <div className="TaskContainerLeftSize">
//                         <div className='TaskContainerVisibleDetails floatLeft'>
//                             <div className='TaskContainerVisibleText'><b> Task Container Name:</b></div>
//                             <input style={{ fontSize: '20px' }} size='40' onChange={this.taskContainerNameChange} type="text" defaultValue={this.props.taskContainerName}></input>
//                         </div>
//                         <div className='width floatLeft'>
...
//                         </div>
//                     </div>
//                     <div className="TaskContainerRightSize ">
//                         <p className='TaskContainerVisibleText verticalMiddle'>Total W.E.: </p>
//                         <p className='totalWorkNumber verticalMiddle'>{(this.getTotalWeightedEffort()).toFixed(1)} {/*sum of all tasks weightedEffort*/}</p>
//                     </div>
//                 </div>
//                 <details>
